...
function generateImage(i) {
  ...
  return `
  <div class="imagebox">
  <img id="image${i}" onclick="openPopup(${i})" class="image_in_imagebox" src="${images[i]}" alt="">
  </div>
  `;
}
...
// function checkIfPortraitFormat(i) {
//   let imageHight = document.getElementById(`images${i}`).height;
//   let imageWidth = document.getElementById(`images${i}`).width;
//   if (imageHight > imageWidth) {
//     document.getElementById(`images${i}`).classList.add("imagebox_portrait");
//   }
// }
