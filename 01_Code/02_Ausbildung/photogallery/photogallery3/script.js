...
// let heightOfColumns = [heightsOfImagesInColumnOne [6, 7, 2, 6, 9], heightsOfImagesInColumnTwo [6, 9, 2, 6,]]
...
function generateImage(i) {
  ...
  return `
  <div class="imagebox">
  <img onclick="openPopup(${i})" class="image_in_imagebox" src="${images[i]}" alt="">
  </div>
  `;
}
...
function getSumOfHeightsOfImagesInColumn() {
  let heightOfOneImage = document.getElementById("myImg").height;
}
